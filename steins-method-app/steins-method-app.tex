...
% \section{Proof of Theorem~\ref{T:HCCLT}}
...
\section{Proof of  Lemma~\ref{L:stein-difference-second-moment-generalization-bound}}
\begin{proof}
  Let
  \begin{equation*}
    f(w) =
...
\section{Proof of Theorem~\ref{T:better-rate}}
\begin{proof}
