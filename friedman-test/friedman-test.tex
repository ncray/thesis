...
function $f$: 
\begin{enumerate}
\item The predicted class label $\text{sign}(\mathbf{w}^t \mathbf{x}_i
+ b)$.
...
logistic link function (Wahba \cite{wahba1992multivariate, wahba1999support}).
\item The margin $\mathbf{w}^t \mathbf{x}_i + b$.
\end{enumerate}
